        ...
        for _, depo in pairs(Config.Depolar) do
            ...
            if distance < Config.Distance then
                ...
                if not depo.personal then
                    DrawText3D(depo.coords.x, depo.coords.y, depo.coords.z, '[E] Ekip Deposu')
                else
                ...
                if distance < 1.5 and IsControlJustReleased(0, 38) then
                    if depo.jobs then
                        ...
                        for job, grade in pairs(depo.jobs) do
                        ...
                        if not hasAccess then
                            QBCore.Functions.Notify("Bu depoyu açmak için yeterli rütbede değilsin.", "error")
                            break
                        end
